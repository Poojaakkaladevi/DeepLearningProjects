...
class CIFAR10DataModule(pl.LightningDataModule):
    def __init__(self, data_dir="./CIFAR10", train_transform=None, test_transform=None, 
                 batch_size=64, seed=42, fraction_train=0.8, small_subset=False, num_samples=None):
        super().__init__()
    ...
    def setup(self, stage=None):
        ...
        if self.small_subset:
            ...
            self.validset_transformed = get_stratified_subset(self.validset_transformed,num_samples=1000,seed=42)
